...
export default function TopicCreateForm({ buttonName, title }: FormProps) {
  ...
  return (
    <Popover placement="left">
      <PopoverTrigger>
        <Button color="primary">Create a Topic{buttonName}</Button>
      </PopoverTrigger>
      <PopoverContent>
        <form action={action}>
          <div className="flex flex-col gap-4 p-4 w-80">
            <h3 className="text-lg">Create a Topic{title}</h3>
